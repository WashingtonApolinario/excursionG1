...
let excursion1 = new Excursion("Titulo1", "Descripcion 1", "Creditos 1", "./images/excursion1.gif","./videos/video1.mp4", pregunta1)

let excursion2 = new Excursion("Titulo2", "Descripcion 2", "Creditos 2", "./images/excursion2.gif","./videos/video2.mp4", pregunta2)

let excursion3 = new Excursion("Titulo1", "Descripcion 1", "Creditos 1", "./images/excursion3.gif","./videos/video3.mp4", pregunta3)

let excursion4 = new Excursion("Titulo1", "Descripcion 1", "Creditos 1", "./images/excursion4.gif","./videos/video4.mp4", pregunta1)
